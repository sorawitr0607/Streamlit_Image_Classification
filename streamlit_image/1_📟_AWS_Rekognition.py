...
st.sidebar.image(r'D:\Image Classification\Streamlit\aws-app\logo.png') 
st.markdown("""
<style>
...
st.sidebar.image(r'D:\Image Classification\Streamlit\aws-app\AWS-Logo.png') 
#######################################################
# --- AWS Configuration ---

env_path = os.path.join(r'D:\Image Classification\Streamlit\aws-app\.env')
...
S3_BUCKET_NAME = "custom-label-motor-claim-sentrics-test"  
LAMBDA_FUNCTION_NAME = "Motor_Claim_Lambda"  
